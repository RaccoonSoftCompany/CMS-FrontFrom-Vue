        ...
        <div class="grid">
          ...
          <a class="grid__item" href="#preview-6">
            <div class="box">
              ...
              <h4 class="box__text">
                <span class="box__text-inner">Fast</span>
              </h4>
              <p class="box__content">
      ...
      <div class="overlay">
        ...
        <div class="overlay__item" id="preview-1">
          <div class="box">
            ...
            />
            <h3 class="box__title">
              <span class="box__title-inner">Memo</span>
            </h3>
            <h4 class="box__text">
              <span class="box__text-inner">Beast</span>
            </h4>
            <div class="box__deco">&#10014;</div>
          </div>
        ...
        <div class="overlay__item" id="preview-3">
          <div class="box">
            ...
            />
            <h3 class="box__title">
              <span class="box__title-inner">West</span>
            </h3>
            <h4 class="box__text box__text--topcloser">
              <span class="box__text-inner">Green</span>
            </h4>
        ...
        <div class="overlay__item" id="preview-5">
          <div class="box">
            ...
            />
            <h3 class="box__title">
              <span class="box__title-inner">Lim</span>
            </h3>
            <h4 class="box__text box__text--bottomcloser">
              <span class="box__text-inner">Breed</span>
            </h4>
        ...
        <div class="overlay__item" id="preview-6">
          <div class="box">
            ...
            />
            <h3 class="box__title">
              <span class="box__title-inner">Hard</span>
            </h3>
